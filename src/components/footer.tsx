...
const Footer = () => {
  ...
  const navigateToSection = (sectionId: NavigateToSectionProps['sectionId']): void => {
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            <h2 className="text-white text-2xl font-semibold">Rishabh Katiyar</h2>
            <p className="text-gray-400">
              Help you create experiences where aesthetics & functionality seamlessly come together.
            </p>
            {/* Social Icons */}
            <div className="flex space-x-4 mt-4">
              <a href="https://www.linkedin.com/in/rishabh-katiyar-30b136252/" className="hover:text-white transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                </svg>
              </a>
              {/* <a href="https://github.com/Pheonixrog" className="hover:text-white transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 text-center text-sm text-gray-600">
          <p>Copyright © {new Date().getFullYear()} Rishabh Katiyar. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
